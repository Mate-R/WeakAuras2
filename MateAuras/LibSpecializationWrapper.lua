...
if not MateAuras.IsCataOrMistsOrRetail() then return end
---@type string
local AddonName = ...
---@class Private
...
MateAuras.SpecForUnit = Private.LibSpecWrapper.SpecForUnit
MateAuras.SpecRolePositionForUnit = Private.LibSpecWrapper.SpecRolePositionForUnit
MateAuras.CheckTalentForUnit = Private.LibSpecWrapper.CheckTalentForUnit

if Private.LibSpecWrapper.CheckGlyphForUnit then
  MateAuras.CheckGlyphForUnit = Private.LibSpecWrapper.CheckGlyphForUnit
else
  MateAuras.CheckGlyphForUnit = function() return nil end
end
