...
local function HandleEvent(_, event, ...)
  ...
  if secretState ~= newSecretState then
    ...
    --   MateAuras.prettyPrint("secret state changed:", newSecretState, "on event:", event)
    -- end
...
function MateAuras.IsSecretStateActive()
  return secretState
end
...
--     return false
--   end
--   MateAuras.DoesAddonRestrictionsActive = DoesAddonRestrictionsActive
-- end
