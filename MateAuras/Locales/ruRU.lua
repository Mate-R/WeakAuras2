...
-- function MateAuras.LoadLocale_ruRU()


--@localization(locale="ruRU", format="lua_additive_table", namespace="MateAuras", handle-subnamespaces="none")@
-- MateAuras
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "Невозможно изменить защищённый кадр во время боя. Подробная информация на странице: https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
...
https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events]=] ] = [=[Использование события COMBAT_LOG_EVENT_UNFILTERED без фильтра не рекомендуется, поскольку это очень затратно с точки зрения производительности. Подробная информация на странице:
...
L["Could not load MateAuras Archive, the addon is %s"] = "Не удалось загрузить MateAuras Archive. Причина - %s"
L["Count"] = "Количество"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "Ошибка при возвращении в пул клона индикации %s, поскольку кадр защищён. Советуем удалить эту индикацию. Подробная информация на странице: https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
L["Error decoding."] = "Ошибка декодирования"
L["Error decompressing"] = "Ошибка распаковки"
L["Error decompressing. This doesn't look like a MateAuras import."] = "Ошибка распаковки. Это не похоже на строку импорта MateAuras"
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/MateAuras!"] = "Если вам необходима дополнительная помощь, пожалуйста, откройте запрос на GitHub или посетите наш сервер в Discord по адресу https://discord.gg/MateAuras."
...
L["Malformed MateAuras link"] = "Неверная ссылка MateAuras"
L["Malygos"] = "Малигос"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Options could not be loaded, the addon is %s"] = "Не удалось загрузить MateAuras Options. Причина - %s"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[Обнаружен защищённый кадр. Подробная информация на странице:
...
L["True"] = "Истина"
L["Trying to repair broken conditions in %s likely caused by a MateAuras bug."] = "Попытка восстановить поврежденные условия в индикации %s, причиной которых стала ошибка аддона."
L["Twilight Lord Kelris"] = "Повелитель сумрака Келрис"
L["Twin Emperors"] = "Императоры-близнецы"
L["Type"] = "Тип"
L["Ulduar"] = "Ульдуар"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-Rb."] = "Невозможно модернизировать ауру '%s'. Вероятно, это связано с повреждением данных или неудачным перемещением. Сообщите об этом команде MateAuras."
...
L["Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."] = "MateAuras.clones объявлено устаревшим. Используйте функцию MateAuras.GetRegion(id, cloneId)."
L["Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."] = "MateAuras.regions объявлено устаревшим. Используйте функцию MateAuras.GetRegion(id)."
...
L["MateAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "MateAuras (встроенный):  63:42 | 3:07 | 10 | 2.4"
L[ [=[MateAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[MateAuras обнаружил, что версия аддона была понижена (осуществлен downgrade). Ваши индикации могут перестать работать должным образом.
...
L["MateAuras has encountered an error during the login process. Please report this issue at https://github.com/Mate-R/MateAuras/issues/new."] = "Во время процесса входа в игру возникла ошибка. Пожалуйста, сообщите об этой проблеме по адресу https://github.com/Mate-R/MateAuras/issues/new."
L["MateAuras Profiling"] = "Профилирование MateAuras"
L["MateAuras Profiling Report"] = "Отчёт профилирования"
L["MateAuras Version: %s"] = "Версия MateAuras: %s"
L["Weapon"] = "Оружие"
...
L["Writing to the MateAuras table is not allowed."] = "Запись в таблицу MateAuras запрещена."
