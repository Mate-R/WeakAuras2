...
L["TimelineParser Stage"] = "타임라인 단계"
L["This trigger requires Mate_Tools of version 71 or higher to function."] = "이 트리거를 사용하려면 Mate_Tools 버전 71 이상이 필요합니다."
L["TimelineParser Timer"] = "타임라인 타이머"
L["The 'ID' value can be found in the TimelineParser source code"] = "'ID' 값은 타임라인 원본 코드에서 확인할 수 있습니다."
