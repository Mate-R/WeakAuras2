...
https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트의 지원은 중단됐습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 성능 소모가 심해 사용할 수 없습니다. 자세한 정보: https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[당신의 위크오라와 MateAuras 시스템 전반에 대한 상세 정보입니다
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[전투 중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Copper"] = "코퍼"
L["Could not load MateAuras Archive, the addon is %s"] = "MateAuras Archive를 불러올 수 없습니다. 애드온이 %s 상태입니다"
L["Count"] = "개수"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보안 요소의 복사본을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=]
L["Error decoding."] = "디코딩 오류입니다."
L["Error decompressing"] = "압축 해제 오류"
L["Error decompressing. This doesn't look like a MateAuras import."] = "압축을 푸는 중 오류가 발생했습니다. MateAuras 가져오기 문자열이 아닙니다."
...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/MateAuras!"] = "더 많은 도움이 필요하다면 GitHub에서 티켓을 열거나 저희 Discord (https://discord.gg/MateAuras)를 방문해 주세요!"
L["Ignore Dead"] = "죽음 무시"
...
L["Malformed MateAuras link"] = "잘못된 MateAuras 링크"
L["Manual"] = "수동 설정"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[보안 프레임이 감지됐습니다. 자세한 정보:
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=]
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the MateAuras Discord server for help."] = "이 필터는 위치 활성 조건으로 이전됐습니다. 새로운 위치 활성 조건을 사용하려면 위크오라를 수정하시고 잘 모르겠으면 MateAuras Discord 서버에 접속해서 도움을 요청하세요."
...
L["True"] = "참"
L["Trying to repair broken conditions in %s likely caused by a MateAuras bug."] = "%s에서 MateAuras 버그로 인해 망가진 조건 복구를 시도중입니다."
L["Twin Emperors"] = "쌍둥이 제왕"
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-R."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 MateAuras 팀에 제보해 주세요."
...
L["Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."] = "MateAuras.clones는 더이상 사용할 수 없습니다. MateAuras.GetRegion(id, cloneId)를 사용하세요."
L["Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."] = "MateAuras.regions는 더이상 사용할 수 없습니다. MateAuras.GetRegion(id)를 사용하세요."
...
L["MateAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "MateAuras 내장 (63:42 | 3:07 | 10 | 2.4)"
L["MateAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/MateAuras."] = "MateAuras가 빈 설정을 감지했습니다. 갑자기 발생한 것이라면 https://discord.gg/MateAuras에서 도움을 요청하세요."
L[ [=[MateAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[MateAuras가 다운그레이드를 감지했습니다.
...
L["MateAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "MateAuras가 보유한 위크오라의 롤백 스냅샷을 생성중입니다. 위크오라에 문제가 발생할 경우 이 스냅샷을 통해 현재 상태의 위크오라로 복원할 수 있습니다. 작업이 완료될 때까지 프레임드랍이 발생할 수 있습니다."
L["MateAuras Profiling"] = "MateAuras 성능 분석"
L["MateAuras Profiling Report"] = "MateAuras 성능 분석 보고서"
L["MateAuras Version: %s"] = "MateAuras 버전: %s"
L["Weapon"] = "무기"
...
L["Writing to the MateAuras table is not allowed."] = "MateAuras 테이블에 작성하는 행위는 허용되지 않습니다."
L["X-Offset"] = "X-위치 조정"
L["Yell"] = "외침"
L["Y-Offset"] = "Y-위치 조정"
...
L["not found"] = "찾을 수 없음"
L["Current Area"] = "현재 지역"
L["State at key: '%s' is a secret table."] = "키 '%s'의 상태는 비밀 테이블입니다."
L["Input is too long to display. If you see this message, there is likely something wrong with your import string."] = "입력 내용이 너무 길어 표시할 수 없습니다. 이 메시지가 표시된다면, 가져오기 문자열에 문제가 있을 가능성이 있습니다."
L["Secret Restrictions Active"] = "비밀 제한 활성화됨"
L["Whether addon secret restrictions applied by Combat, Encounter, PvP match or active Mythic+ dungeon are currently active."] = "전투, 보스 전투, PvP 경기 또는 진행 중인 쐐기돌 던전으로 인한 애드온 비밀 제한이 현재 활성화되어 있는지 여부입니다."
L["TimelineParser Stage"] = "타임라인 분석 단계"
L["This trigger requires Mate_Tools of version 71 or higher to function."] = "이 트리거를 사용하려면 Mate_Tools 버전 71 이상이 필요합니다."
L["TimelineParser Timer"] = "타임라인 분석 타이머"
L["The 'ID' value can be found in the TimelineParser source code"] = "'ID' 값은 타임라인 분석 원본 코드에서 확인할 수 있습니다."
L["Occurrence of the event, reset when aura is unloaded\nCan be a range of values\nCan have multiple values separated by a comma or a space\n\nExamples:\n2nd 5th and 6th events: 2, 5, 6\n2nd to 6th: 2-6\nevery 2 events: /2\nevery 3 events starting from 2nd: 2/3\nevery 3 events starting from 2nd and ending at 11th: 2-11/3"] = "이벤트 발생 횟수(오라가 해제되면 초기화됨)\n값의 범위를 지정할 수 있습니다.\n쉼표나 공백으로 여러 값을 구분할 수 있습니다.\n\n예시:\n2번째, 5번째, 6번째 이벤트: 2, 5, 6\n2번째부터 6번째까지: 2-6\n2번째마다: /2\n2번째부터 시작해 3번째마다: 2/3\n2번째부터 11번째까지 3번째마다: 2-11/3"
L["Bar Color"] = "바 색상"
L["Desaturation percent"] = "채도 감소율"
L["Is Ready (Best guess)"] = "준비 완료 (추정)"
L["Is Ready (Secret)"] = "준비 완료 (비밀)"
L["Boolean"] = "Boolean"
L["Apply when"] = "적용 시점"
L["Priority"] = "우선순위"
