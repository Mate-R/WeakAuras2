...
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-Rb."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 MateAuras 팀에 제보해 주세요."
