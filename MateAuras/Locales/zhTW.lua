...
https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000已經不再支援未過濾的 COMBAT_LOG_EVENT_UNFILTERED|r 因為非常耗效能，已停用沒有過濾程式的 COMBAT_LOG_EVENT_UNFILTERED。更多資訊請看: https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "您的光環和MateAuras系統的詳細概述 如果您需要協助，請將全文複製到Weakaura的Discord。"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "無法在戰鬥鎖定中更改安全框架。查詢更多資訊：https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
...
L["Copper"] = "銅"
L["Could not load MateAuras Archive, the addon is %s"] = "無法載入MateAuras Archive，此插件為 %s"
L["Count"] = "數量"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "錯誤 '%s' 創建了一個安全複製品。我們建議刪除光環。更多訊息：https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
L["Error decoding."] = "解碼時出錯。"
L["Error decompressing"] = "解壓縮時出錯"
L["Error decompressing. This doesn't look like a MateAuras import."] = "解壓縮時出錯，這看起來不像是 MateAuras 的匯入字串。"
...
L["Id"] = "Id"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/MateAuras!"] = "如果你需要其他協助，請在 GitHub 新增問題，或拜訪我們的 Discord https://discord.gg/MateAuras!"
L["Ignore Dead"] = "忽略死者"
...
L["Malformed MateAuras link"] = "格式錯誤的 MateAuras 連結"
L["Manual"] = "手動"
L["Manual Icon"] = "手動圖示"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "檢測到安全框架。查詢更多訊息：https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the MateAuras Discord server for help."] = "這個過濾方式已經移動到位置觸發器。請更改您的提醒效果以使用新的位置觸發器，或加入 MateAuras Discord 伺服器尋求幫助。"
...
L["True"] = "是 (True)"
L["Trying to repair broken conditions in %s likely caused by a MateAuras bug."] = "嘗試修復 %s 中可能是由 MateAuras 的 bug 引起的損壞狀況。"
L["Twin Emperors"] = "雙子皇帝"
L["Type"] = "類型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-Rb."] = "無法更新提醒效果 ‘%s’。可能是由於資料損壞或不良遷移所致，請向 MateAuras 團隊報告此問題。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
...
L["Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."] = "MateAuras.clones 已經被移除，請改用 MateAuras.GetRegion(id, cloneId)。"
L["Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."] = "MateAuras.regions 已經被移除，請改用 MateAuras.GetRegion(id)。"
...
L["MateAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "MateAuras 內建的 (63:42 | 3:07 | 10 | 2.4)"
L["MateAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/MateAuras."] = "MateAuras 偵測到空設定。如果發生意外情況，請在 https://discord.gg/MateAuras 上尋求協助。"
L[ [=[MateAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[MateAuras 偵測到它被降回舊版本，你所儲存的提醒效果已無法正常運作。
是否要執行|cffff0000實驗性的|r修復工具? 將會覆蓋自上次資料庫升級以來所做的任何更改。
上次升級是: %s

|cffff0000在按下此按鈕之前，你應該先備份 WTF 資料夾。|r]=]
L["MateAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "MateAuras 正在建立提醒效果的還原快照。如果出現問題，此快照將允許您恢復到提醒效果目前的狀態。此過程可能會導致幀速下降，直到完成為止。"
L["MateAuras Profiling"] = "MateAuras 效能分析"
L["MateAuras Profiling Report"] = "MateAuras 分析報告"
L["MateAuras Version: %s"] = "MateAuras 版本: %s"
L["Weapon"] = "武器"
...
L["Writing to the MateAuras table is not allowed."] = "不允許寫入 MateAuras table。"
L["X-Offset"] = "水平位移"
L["Yell"] = "大喊"
L["Y-Offset"] = "垂直位移"
