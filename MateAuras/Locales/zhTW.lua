...
L["Type"] = "類型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-R."] = "無法更新提醒效果 ‘%s’。可能是由於資料損壞或不良遷移所致，請向 MateAuras 團隊報告此問題。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
