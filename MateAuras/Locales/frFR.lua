...
https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000La prise en charge des événements COMBAT_LOG_EVENT_UNFILTERED non filtrés est obsolète|r Les événements COMBAT_LOG_EVENT_UNFILTERED sans filtre sont désactivés, car ils nuisent fortement aux performances. Plus d'informations : https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events"
...
L["Malformed MateAuras link"] = "Lien MateAuras mal formé"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."] = "L'utilisation de MateAuras.clones est obsolète. Utilisez plutôt MateAuras.GetRegion(id, cloneId)."
L["Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."] = "L'utilisation de MateAuras.regions est obsolète. Utilisez plutôt MateAuras.GetRegion(id)."
