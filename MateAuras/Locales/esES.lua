...
L["Type"] = "Tipo"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-R."] = "No se puede modernizar el aura '%s'. Probablemente se deba a datos corruptos o una migración incorrecta. Por favor, informe de esto al equipo de MateAuras."
