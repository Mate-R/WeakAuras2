...
L["Current Area"] = "Current Area"
L["State at key: '%s' is a secret table."] = "State at key: '%s' is a secret table."
L["Input is too long to display. If you see this message, there is likely something wrong with your import string."] = "Input is too long to display. If you see this message, there is likely something wrong with your import string."
L["Secret Restrictions Active"] = "Secret Restrictions Active"
L["Whether addon secret restrictions applied by Combat, Encounter, PvP match or active Mythic+ dungeon are currently active."] = "Whether addon secret restrictions applied by Combat, Encounter, PvP match or active Mythic+ dungeon are currently active."
L["TimelineParser Stage"] = "TimelineParser Stage"
L["This trigger requires Mate_Tools of version 71 or higher to function."] = "This trigger requires Mate_Tools of version 71 or higher to function."
L["TimelineParser Timer"] = "TimelineParser Timer"
L["The 'ID' value can be found in the TimelineParser source code"] = "The 'ID' value can be found in the TimelineParser source code"
...
L["Desaturation percent"] = "Desaturation percent"
L["Is Ready (Best guess)"] = "Is Ready (Best guess)"
L["Is Ready (Secret)"] = "Is Ready (Secret)"
L["Boolean"] = "Boolean"
