...
https://github.com/Mate-R/MateAuras/wiki/Custom-Triggers#events]=] ] = [=[|cFFFF0000Support for unfiltered COMBAT_LOG_EVENT_UNFILTERED is deprecated|r
COMBAT_LOG_EVENT_UNFILTERED without a filter are disabled as it’s very performance costly.
Find more information:
...
--[[Translation missing --]]
L[ [=[A detailed overview of your auras and MateAuras systems
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[A detailed overview of your auras and MateAuras systems
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[Cannot change secure frame in combat lockdown. Find more information:
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=]
--[[Translation missing --]]
...
L["Copper"] = "Copper"
--[[Translation missing --]]
L["Could not load MateAuras Archive, the addon is %s"] = "Could not load MateAuras Archive, the addon is %s"
L["Count"] = "Anzahl"
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[Error '%s' created a secure clone. We advise deleting the aura. For more information:
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=]
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Error decompressing. This doesn't look like a MateAuras import."] = "Error decompressing. This doesn't look like a MateAuras import."
--[[Translation missing --]]
...
L["ID"] = "ID"
--[[Translation missing --]]
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/MateAuras!"] = "If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/MateAuras!"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Malformed MateAuras link"] = "Malformed MateAuras link"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = [=[Secure frame detected. Find more information:
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=]
...
--[[Translation missing --]]
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the MateAuras Discord server for help."] = "This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the MateAuras Discord server for help."
--[[Translation missing --]]
...
L["True"] = "Zutrifft"
--[[Translation missing --]]
L["Trying to repair broken conditions in %s likely caused by a MateAuras bug."] = "Trying to repair broken conditions in %s likely caused by a MateAuras bug."
L["Twin Emperors"] = "Zwillingsimperatoren"
L["Type"] = "Typ"
--[[Translation missing --]]
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-R."] = "Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-Rb."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."] = "Using MateAuras.clones is deprecated. Use MateAuras.GetRegion(id, cloneId) instead."
--[[Translation missing --]]
L["Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."] = "Using MateAuras.regions is deprecated. Use MateAuras.GetRegion(id) instead."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["MateAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "MateAuras Built-In (63:42 | 3:07 | 10 | 2.4)"
--[[Translation missing --]]
L["MateAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/MateAuras."] = "MateAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/MateAuras."
--[[Translation missing --]]
L[ [=[MateAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[MateAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s
...
--[[Translation missing --]]
L["MateAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "MateAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."
--[[Translation missing --]]
L["MateAuras Profiling"] = "MateAuras Profiling"
--[[Translation missing --]]
L["MateAuras Profiling Report"] = "MateAuras Profiling Report"
--[[Translation missing --]]
L["MateAuras Version: %s"] = "MateAuras Version: %s"
L["Weapon"] = "Waffen"
...
--[[Translation missing --]]
L["Writing to the MateAuras table is not allowed."] = "Writing to the MateAuras table is not allowed."
