...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Una panoramica dettagliata delle tue aure e dei sistemi MateAuras, Copia l'intero testo su Discord di Weakaura se hai bisogno di assistenza."
--[[Translation missing --]]
...
https://github.com/Mate-R/MateAuras/wiki/Protected-Frames]=] ] = "Non è possibile modificare il frame protetto durante il blocco del combattimento. Trova ulteriori informazioni: https://github.com/Mate-R/MateAuras/wiki/Protected-Frames"
...
--[[Translation missing --]]
L["Copper"] = "Copper"
L["Could not load MateAuras Archive, the addon is %s"] = "Impossibile caricare l'archivio MateAuras, il componente aggiuntivo è %s"
L["Count"] = "Conteggio "
