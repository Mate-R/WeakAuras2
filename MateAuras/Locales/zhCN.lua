...
L["Type"] = "类型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to Mate-R."] = "无法现代化光环'%s'。这个可能是因为数据错误或者升级流程错误，请报告给MateAuras团队。"
L["Unaffected"] = "未受影响"
L["Undefined"] = "未定义"
L["Unholy"] = "邪恶"
