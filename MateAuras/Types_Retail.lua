...
local classIDToOffsets = {
	[1] = { extraOffsetX = MateAuras.IsTWW() and 60 or 30, extraOffsetY = 31, }, -- Warrior
...
function Private.GetTalentData(specId)
  ...
  local specDataByNodeId = {}
	...
	local subTreeIDs = MateAuras.IsTWW() and C_ClassTalents.GetHeroTalentSpecsForClassSpec(configId, specId) or {}
...
for k, v in pairs(texture_data) do
	...
	if atlasInfo then
		...
		MateAuras.StopMotion.texture_data[k] = v
		MateAuras.StopMotion.texture_types.Blizzard[k] = k
	end
end
