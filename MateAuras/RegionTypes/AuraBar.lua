      ...
      if self.activeMask == "secret" or true then
        ...
        for index, additionalBar in ipairs(self.additionalBars) do
          ...
          if not abar then
            ...
            abar:SetStatusBarTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite");
            ...
            abar.textureMask:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite",
            ...
            abar.offsetBar1:SetStatusBarTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite");
            abar.offsetBar1:SetColorFill(1, 1, 1, 0);

            abar.offsetBar2 = CreateFrame("StatusBar", nil, abar);
            abar.offsetBar2:SetStatusBarTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite");
          ...
          elseif direction and width then
            ...
            if not abar.offsetBarAdditional then
              ...
              abar.offsetBarAdditional:SetStatusBarTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite");
          ...
          if durationObject and MateAuras.IsDurationObject(durationObject) then
            -- elapsed is default
...
local funcs = {
  ...
  SetProgressSecret = function(self)
    ...
    if self.secretProgress == "duration" and MateAuras.IsDurationObject(self.durationObject) then
...
local function create(parent)
  ...
  secretBar:SetStatusBarTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite");
  secretBar:SetColorFill(1, 1, 1, 0);
  local secretBarMask = bar:CreateMaskTexture()
  secretBarMask:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite",
                    "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE", "NEAREST")
  ...
  fgMask:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite",
                    "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE", "NEAREST")
...
-- Register new region type with MateAuras
