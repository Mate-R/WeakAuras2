...
local function create(parent)
  ...
  -- Border region
  local border = CreateFrame("Frame", nil, region, "BackdropTemplateMateAuras");
...
local function ConfigureModel(region, model, data)
  ...
  -- Adjust model
  MateAuras.SetModel(model, nil, data.model_fileId, data.modelIsUnit, data.modelDisplayInfo)
  ...
  if data.modelIsUnit then
    ...
    elseif not MateAuras.IsClassicEra() and unit == "focus" then
