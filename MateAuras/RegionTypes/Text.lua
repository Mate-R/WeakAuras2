...
local function create(parent)
  ...
  local fontObject = CreateFont("MateAuras-Text-Font" .. fontObjectCounter)
...
local function modify(parent, region, data)
  ...
  if containsCustomText and data.customText and data.customText ~= "" then
    customTextFunc = MateAuras.LoadFunction("return "..data.customText, data.id)
...
local function fallbackmodify(parent, region, data)
  ...
  if text:GetFont() then
    text:SetText(MateAuras.L["Region type %s not supported"]:format(data.regionType));
  end
