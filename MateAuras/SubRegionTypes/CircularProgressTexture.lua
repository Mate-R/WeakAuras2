...
local default = function(parentType)
  local defaults = {
    ...
    circularTextureTexture = "Interface\\AddOns\\MateAuras\\Media\\Textures\\square_border_5px.tga",
...
MateAuras.RegisterSubRegionType("subcirculartexture", L["Circular Texture"], supports, create, modify, onAcquire, onRelease,
