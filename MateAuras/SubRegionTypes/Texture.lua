...
local default = function(parentType)
  local defaults = {
    ...
    textureTexture = "Interface\\Addons\\MateAuras\\PowerAurasMedia\\Auras\\Aura3",
...
MateAuras.RegisterSubRegionType("subtexture", L["Texture"], supports, create, modify, onAcquire, onRelease, default, nil, properties)
