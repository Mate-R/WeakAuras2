...
local default = function(parentType)
  local defaults = {
    ...
    linearTextureTexture = "Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite",
...
MateAuras.RegisterSubRegionType("sublineartexture", L["Linear Texture"], supports, create, modify, onAcquire, onRelease,
