...
local default = function(parentType)
  local defaults = {
    ...
    stopmotionTexture = "Interface\\AddOns\\MateAuras\\Media\\Textures\\stopmotion",
  ...
  if C_AddOns.IsAddOnLoaded("MateAurasStopMotion") then
    defaults.stopmotionTexture = "Interface\\AddOns\\MateAurasStopMotion\\Textures\\IconOverlays\\ArcReactor"
...
MateAuras.RegisterSubRegionType("substopmotion", L["Stop Motion"], supports, create, modify, onAcquire, onRelease, default, nil, properties)
