...
if not MateAuras.IsRetail() then return end
local L = MateAuras.L
...
-- Collected by MateAurasTemplateCollector:
--------------------------------------------------------------------------------
...
tinsert(templates.general.args, {
  ...
  icon = "Interface\\Addons\\MateAuras\\PowerAurasMedia\\Auras\\Aura78",
  triggers = {[1] = { trigger = {
    type = MateAuras.GetTriggerCategoryFor("Conditions"),
    event = "Conditions",
    use_alwaystrue = true}}}
});
...
tinsert(templates.general.args, {
  ...
  triggers = {[1] = { trigger = {
    type = MateAuras.GetTriggerCategoryFor("Pet Behavior"),
    event = "Pet Behavior",
    use_behavior = true,
    behavior = "assist"}}}
});
...
for i = 1, 4 do
  ...
  tinsert(templates.class.DRUID[i][resourceSection].args, {
    ...
    icon = 132276,
    triggers = {[1] = { trigger = {
      type = MateAuras.GetTriggerCategoryFor("Stance/Form/Aura"),
...
for i = 1, 3 do
  ...
  tinsert(templates.class.DEATHKNIGHT[i][resourceSection].args, {
    ...
    triggers = {[1] = { trigger = {
      type = MateAuras.GetTriggerCategoryFor("Death Knight Rune"),
