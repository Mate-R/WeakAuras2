...
local L = MateAuras.L;
local GetAtlasInfo = MateAuras.IsClassicEra() and GetAtlasInfo or C_Texture.GetAtlasInfo
...
local function createIcon()
  local data = {
    foregroundTexture = "Interface\\Addons\\MateAuras\\PowerAurasMedia\\Auras\\Aura3",
    backgroundTexture = "Interface\\Addons\\MateAuras\\PowerAurasMedia\\Auras\\Aura3",
    sameTexture = true,
    backgroundOffset = 2,
    blendMode = "BLEND",
    width = 200,
