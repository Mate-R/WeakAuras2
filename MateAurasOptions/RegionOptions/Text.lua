...
local function createOptions(id, data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(options, data, L["Custom Function"], "customText", "https://github.com/Mate-R/MateAuras/wiki/Custom-Code-Blocks#custom-text",
...
local function createThumbnail()
  ...
  local fontObject = CreateFont("MateAuras-TextThumbnail-Font" .. thumbnailFontObjectCounter)
