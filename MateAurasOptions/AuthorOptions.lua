...
typeControlAdders = {
  ...
  number = function(options, args, data, order, prefix, i)
    ...
    args[prefix .. "min"] = {
      type = "input",
      width = MateAuras.normalWidth * 2 / 3,
  ...
  multiselect = function(options, args, data, order, prefix, i)
    ...
    args[prefix .. "default"] = {
      type = "multiselect",
      width = MateAuras.normalWidth * 0.9,
      name = L["Default"],
      order = order(),
      values = defaultValues,
      get = function(_, k)
  ...
  group = function(options, args, data, order, prefix, i)
    ...
    args[prefix .. "noMerge"] = {
      type = "toggle",
      name = MateAuras.newFeatureString .. name(option, "noMerge", L["Prevent Merging"]),
      desc = desc(option, "noMerge", L["If checked, then this group will not merge with other group when selecting multiple auras."]),
      order = order(),
      width = option.groupType =="simple" and MateAuras.doubleWidth or MateAuras.normalWidth,
    ...
    if option.groupType ~="simple" then
      args[prefix .. "sortAlphabetically"] = {
        type = "toggle",
        name = MateAuras.newFeatureString .. name(option, "sortAlphabetically", L["Sort"]),
...
function addAuthorModeOption(options, args, data, order, prefix, i)
  ...
  args[prefix .. "collapse"] = {
    ...
    order = order(),
    width = MateAuras.doubleWidth - buttonWidth,
    func = function()
      for id, optionData in pairs(option.references) do
    ...
    image = collapsed and "Interface\\AddOns\\MateAuras\\Media\\Textures\\expand" or
      "Interface\\AddOns\\MateAuras\\Media\\Textures\\collapse",
    imageWidth = 18,
    imageHeight = 18,
  ...
  args[prefix .. "upAndIn"] = {
    ...
    image = "Interface\\AddOns\\MateAuras\\Media\\Textures\\upright",
    imageWidth = 24,
    imageHeight = 24,
    control = "MateAurasIcon"
  }
  args[prefix .. "downAndIn"] = {
    ...
    image = "Interface\\AddOns\\MateAuras\\Media\\Textures\\downright",
    imageWidth = 24,
    imageHeight = 24,
    control = "MateAurasIcon"
  }
  ...
  args[prefix .. "upAndOut"] = {
    ...
    func = function()
      for id, optionData in pairs(option.references) do
        ...
        MateAuras.Add(optionData.data)
      end
      MateAuras.ClearAndUpdateOptions(data.id, true)
    end,
    image = "Interface\\AddOns\\MateAuras\\Media\\Textures\\upleft",
    imageWidth = 24,
    imageHeight = 24,
    control = "MateAurasIcon"
  }
  args[prefix .. "downAndOut"] = {
    ...
    image = "Interface\\AddOns\\MateAuras\\Media\\Textures\\downleft",
    imageWidth = 24,
    imageHeight = 24,
    control = "MateAurasIcon"
  }
  ...
  if optionClass == "simple" then
    ...
    args[prefix .. "tooltip"] = {
      ...
      order = order(),
      width = MateAuras.normalWidth * 1.5,
...
local function addUserModeOption(options, args, data, order, prefix, i)
  ...
  if optionClass == "simple" then
    userOption = {
      ...
      width = (option.width or 1) * MateAuras.normalWidth,
      order = order(),
      get = getUser(option),
    ...
    if not collapsed then
      ...
      if option.groupType == "array" then
        ...
        args[prefix .. "resetEntry"] = {
          ...
          width = 0.15,
          image = "Interface\\Addons\\MateAuras\\Media\\Textures\\reset",
          imageWidth = 18,
          imageHeight = 18,
          control = "MateAurasIcon"
        }
        if option.limitType ~= "fixed" then
          args[prefix .. "createEntry"] = {
            ...
            width = 0.15,
            image = "Interface\\AddOns\\MateAuras\\Media\\Textures\\add",
            imageWidth = 18,
            imageHeight = 18,
            control = "MateAurasIcon"
          }
  ...
  -- convert from MateAuras option type to ace option type
  if optionClass == "simple" then
