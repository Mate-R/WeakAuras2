...
local function ConstructModelPicker(frame)
  ...
  local filterInput = CreateFrame("EditBox", "MateAurasFilterInput", group.frame, "SearchBoxTemplate")
  ...
  local modelTree = AceGUI:Create("MateAurasTreeGroup");
  ...
  modelTree:SetTree(MateAuras.ModelPaths);
  ...
  function group.PickSt(self, model_fileId, model_tx, model_ty, model_tz, model_rx, model_ry, model_rz, model_us)
    ...
    MateAuras.SetModel(self.model, nil, self.selectedValues.model_fileId)
