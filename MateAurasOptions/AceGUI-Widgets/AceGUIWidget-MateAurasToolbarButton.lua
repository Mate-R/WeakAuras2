...
Graphical Button.
-------------------------------------------------------------------------------]]
local Type, Version = "MateAurasToolbarButton", 7
...
local function Constructor()
	...
	hTex:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite")
	...
	pTex:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite")
