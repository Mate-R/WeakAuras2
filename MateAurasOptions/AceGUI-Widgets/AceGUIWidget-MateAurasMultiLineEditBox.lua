...
local Type, Version = "MateAurasMultiLineEditBox", 39
...
if not AceGUIMateAurasMultiLineEditBoxInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIMateAurasMultiLineEditBoxInsertLink(...) end)
end

function _G.AceGUIMateAurasMultiLineEditBoxInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("MateAurasMultiLineEditBox%uEdit"):format(i)]
...
local function Constructor()
  ...
  local scrollBG = CreateFrame("Frame", nil, frame, "BackdropTemplateMateAuras")
