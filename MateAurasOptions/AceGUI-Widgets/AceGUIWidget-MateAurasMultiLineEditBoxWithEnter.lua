...
local Type, Version = "MateAuras-MultiLineEditBoxWithEnter", 2
...
if not AceGUIMateAurasMultiLineEditBoxWithEnterInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIMateAurasMultiLineEditBoxWithEnterInsertLink(...) end)
end

function _G.AceGUIMateAurasMultiLineEditBoxWithEnterInsertLink(text)
