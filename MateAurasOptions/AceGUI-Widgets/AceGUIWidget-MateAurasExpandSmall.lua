...
local Type, Version = "MateAurasExpandSmall", 4
...
local methods = {
  ...
  ["SetImage"] = function(self, path, ...)
    ...
    if path == "collapsed" then
      ...
      path = "Interface\\AddOns\\MateAuras\\Media\\Textures\\gear"
    elseif path == "expanded" then
      self:SetExpandedState(true)
      path = "Interface\\AddOns\\MateAuras\\Media\\Textures\\geardown"
    else
      self:SetExpandedState(false)
    end
...
local function Constructor()
  ...
  highlight:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_White")
  ...
  expandedHighlight:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_White")
  ...
  expandedBackground:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_AlphaGradient")
