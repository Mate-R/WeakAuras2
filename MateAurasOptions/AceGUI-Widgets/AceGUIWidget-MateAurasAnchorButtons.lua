...
local Type, Version = "MateAurasAnchorButtons", 2
...
local function Constructor()
  local name = "MateAurasAnchorButtons" .. AceGUI:GetNextWidgetNum(Type)
  ...
  local background = CreateFrame("Frame", nil, frame, "BackdropTemplateMateAuras")
  background:SetSize(frameWidth, frameHeight)
  background:SetPoint("TOP", frame, "TOP", 0, -(titleHeight + 4))
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_FullWhite.tga")
