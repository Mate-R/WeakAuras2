...
local Type, Version = "MateAurasInputWithIndentation", 2
...
if not AceGUIMateAurasInputWithIndentationInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIMateAurasInputWithIndentationInsertLink(...) end)
end

function _G.AceGUIMateAurasInputWithIndentationInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("MateAurasInputWithIndentation%uEdit"):format(i)]
...
local function Constructor()
  ...
  local editbox = CreateFrame("EditBox", string.format("MateAurasInputWithIndentation%uEdit", format(num)), frame, "InputBoxTemplate")
