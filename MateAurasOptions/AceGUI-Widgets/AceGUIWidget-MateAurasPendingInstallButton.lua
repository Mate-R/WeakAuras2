...
local Type, Version = "MateAurasPendingInstallButton", 3
...
local methods = {
  ...
  ["Initialize"] = function(self, id, companionData)
    ...
    function self.callbacks.OnUpdateClick()
      MateAuras.Import(self.companionData.encoded)
    end
...
local function Constructor()
  local name = "MateAurasPendingInstallButton" .. AceGUI:GetNextWidgetNum(Type)
