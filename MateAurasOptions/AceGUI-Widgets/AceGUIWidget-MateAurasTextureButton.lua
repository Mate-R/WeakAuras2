...
local Type, Version = "MateAurasTextureButton", 26
...
local function Constructor()
  local name = "MateAurasTextureButton"..AceGUI:GetNextWidgetNum(Type);
  local button = CreateFrame("Button", name, UIParent, "OptionsListButtonTemplate");
  if BackdropTemplateMateAurasMixin then
    Mixin(button, BackdropTemplateMateAurasMixin)
  end
