...
-------------------------------------------------------------------------------]]
local Type, Version = "MateAurasProgressBar", 2
...
local function Constructor()
  ...
  foreground:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_White")
  background:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_White")
