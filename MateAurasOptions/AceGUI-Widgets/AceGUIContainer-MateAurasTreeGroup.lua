...
local function Constructor()
	...
	local treeframeBG = CreateFrame("Frame", nil, treeframe, "BackdropTemplateMateAuras")
	...
	local dragger = CreateFrame("Frame", nil, treeframe, "BackdropTemplateMateAuras")
	dragger:SetWidth(8)
	...
	local border = CreateFrame("Frame", nil, frame, "BackdropTemplateMateAuras")
