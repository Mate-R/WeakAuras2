...
Spin Box Widget
-------------------------------------------------------------------------------]]
local Type, Version = "MateAurasSpinBox", 5
...
local progressLeftOffset = MateAuras.IsClassicOrWrathOrCata() and -2 or -3
local progressExtraWidth = MateAuras.IsClassicOrWrathOrCata() and -2 or 0
local progressTopOffset = MateAuras.IsClassicOrWrathOrCata() and -3 or -2
local progressBottomOffset = MateAuras.IsClassicOrWrathOrCata() and 3 or 2
...
local function Constructor()
  ...
  leftbutton:SetSize(16, 16)
	leftbutton:SetNormalTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxleft")
  leftbutton:SetHighlightTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxlefth")
	leftbutton:SetPushedTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxleftp")
	leftbutton:SetDisabledTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxleftp")
  leftbutton:SetScript("OnClick", SpinBox_OnValueDown)

  local rightbutton = CreateFrame("Button", nil, frame)
  rightbutton:SetSize(16, 16)
	rightbutton:SetNormalTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxright")
  rightbutton:SetHighlightTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxrighth")
	rightbutton:SetPushedTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxrightp")
	rightbutton:SetDisabledTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxrightp")
  ...
  progressBar:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\spinboxoverlay")
  ...
  progressBarHandleTexture:SetTexture("Interface\\AddOns\\MateAuras\\Media\\Textures\\Square_White")
