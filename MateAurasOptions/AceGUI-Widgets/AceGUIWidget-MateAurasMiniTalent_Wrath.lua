...
local widgetType, widgetVersion = "MateAurasMiniTalent", 3
...
local function Constructor()
  ...
  -- rescale buttons and resize frame to fit in MateAuras options
  ...
  local toggle = AceGUI:Create("MateAurasToolbarButton")
