...
local function GetGlobalOptions(data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(globalTriggerOptions, data, L["Custom"], "custom_trigger_combination", "https://github.com/Mate-R/MateAuras/wiki/Custom-Code-Blocks#custom-activation",
...
function OptionsPrivate.AddTriggerMetaFunctions(options, data, triggernum)
  ...
  options.__delete = {
    ...
    func = function(...)
      ...
      if canDelete then
        StaticPopupDialogs["MateAuras_CONFIRM_TRIGGER_DELETE"] = {
        ...
        StaticPopup_Show("MateAuras_CONFIRM_TRIGGER_DELETE")
      end
    end
  }
