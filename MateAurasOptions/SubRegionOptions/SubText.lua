...
local function createOptions(parentData, data, index, subIndex)
  ...
  local options = {
    ...
    text_text = {
      ...
      control = "MateAurasInputWithIndentation",
      callbacks = {
    ...
    text_smoothScaling = {
      type = "toggle",
      width = MateAuras.normalWidth - indentWidth,
      name = MateAuras.newFeatureString .. L["Smooth Font"],
  ...
  OptionsPrivate.commonOptions.AddCodeOption(commonTextOptions, parentData, L["Custom Function"], "customText",
                          "https://github.com/Mate-R/MateAuras/wiki/Custom-Code-Blocks#custom-text",
  ...
  local function addOption(key, option)
    ...
    if option.reloadOptions then
      ...
      option.set = function(info, v)
        ...
        MateAuras.Add(parentData)
        MateAuras.ClearAndUpdateOptions(parentData.id, true)
      end
    end
...
MateAuras.RegisterSubRegionOptions("subtext", createOptions,
