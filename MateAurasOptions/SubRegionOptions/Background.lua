...
do
  ...
  MateAuras.RegisterSubRegionOptions("subbackground", subCreateOptions, L["Background"]);
end
...
do
  ...
  MateAuras.RegisterSubRegionOptions("subforeground", subCreateOptions, L["Foreground"]);
end
