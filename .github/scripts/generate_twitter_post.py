...
MateAuras_URL_RELEASE_URL = "https://github.com/Mate-R/MateAuras/releases/tag/{tag}"
MAX_POST_LENGTH = 280

POST_TEMPLATE = """MateAuras {tag} released:
...
def get_empty_post_length():
    tag = get_latest_tag()
    release_url = MateAuras_URL_RELEASE_URL.format(tag=tag)
