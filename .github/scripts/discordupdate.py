...
MSG = """React to this message to have your name included in the Thanks list inside the MateAuras GUI.
...
class DiscordNameGather(discord.Client):
  ...
  def writeFile(self):
    ...
    discordListFile = open("MateAuras/DiscordList.lua", "w", encoding="utf-8")
    discordListFile.write("if not MateAuras.IsLibsOK() then return end\n")
